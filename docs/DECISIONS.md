...
| Decision | Reason |
|---|---|
| **The owner's Gemini use is paid, not free:** billing is on, with €15 paid in advance. His Gemini key belongs to the project "Default Gemini Project"; its budget "Jobcu AI (Gemini)" has Google's spend cap at **€28 a month** (below the €30, because Google warns that enforcement isn't instant). Real tests on his key therefore cost a little money: keep them small, within the €30 a month (AGENTS.md). | Seen on his Budgets & alerts screen: €0.58 spent on the Gemini API this month. "No credits used" there only means no free promotional credit from Google, not that his €15 is untouched. |
...
| **Only two Google budgets, one per thing Jobcu uses:** "Jobcu AI (Gemini)" and "Jobcu Google Maps". The account-wide €20 alert was removed. | The owner wants it clean and simple. Nothing else runs on his billing account; if that changes, add a budget for it. |
